...
import { CATEGORY_META, computeResults, getSliderLabel } from "./diagnosis-data";
        ...
        {loading ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {entries.map((entry) => {
              ...
              return (
                <button key={entry.id} onClick={() => setSelected(entry)} style={{ background: COLORS.surface, border: `1px solid ${COLORS.border}`, borderRadius: 10, padding: 16, cursor: "pointer", textAlign: "left" }}>
